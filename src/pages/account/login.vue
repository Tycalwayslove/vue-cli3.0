...
<template>
    <div class="login-page">
        <p>身份认证一般都是通过登陆接口向后台发送账号密码验证码之类的认证信息，然后后台返回一个token外加一些其他的数据。而一般都会和约定好请求接口时需要传递的消息头，其中token一般为必须项。这里仅简单的演示当获取到接口返回的数据后，如何使用localStorage 结合vuex来存储和移除数据。总的来说，应该还有token 失效的情况，请求拦截的时候可以设置判断条件。</p>
